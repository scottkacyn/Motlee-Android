...
public class InviteFriendsAdapter extends BaseAdapter {
	...
	private ArrayList<FacebookFriend> mOriginalData = new ArrayList<FacebookFriend>();
	private ArrayList<FacebookFriend> mData = new ArrayList<FacebookFriend>();
	...
	public InviteFriendsAdapter(Context context, LayoutInflater inflater, ArrayList<FacebookFriend> facebookFriends)
	{
		super();
		...
		mOriginalData = new ArrayList<FacebookFriend>(facebookFriends);
		mData = new ArrayList<FacebookFriend>(facebookFriends);
