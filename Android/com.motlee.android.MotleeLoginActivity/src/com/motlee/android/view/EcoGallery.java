...
public class EcoGallery extends CustomAbsSpinner implements com.motlee.android.view.CustomAdapterView.OnItemClickListener {
     ...
     private int getCenterOfGallery() {
    	 ...
    	 int center = (this.mSelectedChild.getRight() - this.mSelectedChild.getLeft()) / 2;
	...
	public boolean onItemLongClick(CustomAdapterView<?> parent, View view,
			int position, long id) {
		
		PhotoItem photo = (PhotoItem) getItemAtPosition(position);
		
		if (photo == ImageAdapter.NO_PHOTO && mIsAttending)
		{
	...
	public void onItemClick(CustomAdapterView<?> parent, View view,
			int position, long id) {
