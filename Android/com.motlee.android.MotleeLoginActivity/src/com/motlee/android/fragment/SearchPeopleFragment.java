	        ...
	        Bundle savedInstanceState)
	{
		...
		if (showSkipButton)
		{
			...
			mHeaderView.findViewById(R.id.header_left_square_button).setOnClickListener(skipButton);
			 ...
			 leftText.setTypeface(GlobalVariables.getInstance().getGothamLightFont());
				...
				if (response != null && response.getGraphObject() != null)
				{
			    	...
			    	mHandler.post(new Runnable() {
			    		...
			    		public void run() { 
			    			...
			    			if (view != null)
			    			{
			    				View progressBar = view.findViewById(R.id.search_progress_bar);
			    				if (progressBar != null)
			    				{
			    					progressBar.setVisibility(View.GONE);
			    				}
			    				
			    				View searchList = view.findViewById(R.id.search_list);
			    				if (searchList != null)
			    				{
