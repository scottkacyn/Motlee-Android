...
public class StretchedBackgroundLinearLayout extends LinearLayout {
	...
	public StretchedBackgroundLinearLayout(Context context) {
		super(context);
	...
	public StretchedBackgroundLinearLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
